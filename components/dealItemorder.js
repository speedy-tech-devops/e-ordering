...
return (
    <div className={style.dealItem}>
            ...
            <div className={style.group_dealitem}>
                <div className={style.deal_name}><span className={style.nameOrder}>{dealItem.product.name[locale]}</span> <span className={style.priceOrder}>฿ {dealItem.unit_price.toLocaleString('en-US')} x {dealItem.qty}</span></div>
